...
import IFA_LLLBINARY from '../src/packer/IFA_LLLBINARY';
import ISOUtil from '../src/ISOUtil';
import chai from 'chai';
const assert = chai.assert;

  
describe('IFA_LLLBINARY.js', function() {

  it('Should pack', function(done) {
    let field = new ISOBinaryField(12, [28, 13]);
    let packager = new IFA_LLLBINARY(2, "Should be 1C0D");
  ...
  it('Should pack and unpack - reversability', function(done) {
    ...
    let packager = new IFA_LLLBINARY(4, "Should be 1C345678");
