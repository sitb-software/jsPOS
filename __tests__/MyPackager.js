...
import ISOBasePackager from '../src/ISOBasePackager';
import IFB_NUMERIC from '../src/packer/IFB_NUMERIC';
import IFB_BITMAP from '../src/packer/IFB_BITMAP';
import IFB_LLNUM from '../src/packer/IFB_LLNUM';
import IFB_LLLNUM from '../src/packer/IFB_LLLNUM';
import IF_CHAR from '../src/packer/IF_CHAR';
import IFB_LLCHAR from '../src/packer/IFB_LLCHAR';
import IFB_LLLCHAR from '../src/packer/IFB_LLLCHAR';
import IFB_BINARY from '../src/packer/IFB_BINARY';
import IFB_LLBINARY from '../src/packer/IFB_LLBINARY';
import IFB_LLLBINARY from '../src/packer/IFB_LLLBINARY';
...
class MyPackager extends ISOBasePackager {
    ...
    constructor() {
        ...
        let fld = [
            ...
            /*060*/ new IFB_LLLNUM(999, "Reserved for national use", pad),
            /*061*/ new IFB_LLLNUM(29, "Reserved for national use", pad),
