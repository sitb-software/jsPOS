...
import IFA_LLLLCHAR from '../src/packer/IFA_LLLLCHAR';
import ISOUtil from '../src/ISOUtil';
import chai from 'chai';

const assert = chai.assert;

describe('IFA_LLLLCHAR.js', function() {

  it('Should pack', function(done) {
    let field = new ISOField(12, "ABCD");
    let packager = new IFA_LLLLCHAR(10, "Should be 004ABCD");
  ...
  it('Should pack and unpack - reversability', function(done) {
    ...
    let packager = new IFA_LLLLCHAR(10, "Should be Abc123:.-");
